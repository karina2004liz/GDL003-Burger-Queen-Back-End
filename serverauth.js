...
var app = express();
var User   = require('./src/userServices/user'); 
var middleware = require('./src/userServices/middleware');
var service = require('./src/userServices/service');
...
// Connection to DB
mongoose.connect(CONNECTION_URL, function(err, res) {
 if(err) throw err;
